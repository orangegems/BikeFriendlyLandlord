...
export default function ProfilePage({ userData }) {
  ...
  React.useEffect(() => {
    axios
      .get(`http://localhost:3000/landlords/getById/${landlordId.landlord_id}`)
      .then((landlordObject) => {
    ...
    axios
      .get(
        `http://localhost:3000/reviews/landlordReviews/${landlordId.landlord_id}`
      )
      .then((reviewArray) => {
              ...
              <Card sx={{ minWidth: 275 }}>
                <CardContent>
                  <div className="ProfilePicture">
                    <img
                      style={{ height: "100px" }}
                      src={`http://localhost:3000/images/${landlordData.profile_pic}`}
                    />
                  </div>
                </CardContent>
              </Card>
