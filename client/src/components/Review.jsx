                    ...
                    <CardContent direction="row">
                        ...
                        <Stack spacing={5} direction="row" >
                            <Stack spacing={2} direction="row" >
                                ...
                                <Rating required size="small" precision={0.5} value={overall_rating} />
                            </Stack>
                            <Stack spacing={2} direction="row" >
                                <Typography variant= 'h7'>Respectful</Typography>
                                <Rating required size="small" precision={0.5} value={respect_rating} />  
                            </Stack>
                            <Stack spacing={2} direction="row">
                                <Typography variant= 'h7'>Responsiveness</Typography>
                                <Rating required size="small" precision={0.5} value={responsiveness_rating} />
                            </Stack>
                            <Stack spacing={2} direction="row">
